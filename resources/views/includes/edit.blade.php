<form action="{{ route('form.editRecord') }}" method="post" enctype="multipart/form-data" class="mb-5">
    @csrf
    <!--1st Row--->
        ...
        <div class="col-md-4">
            <div class="input-group-sm mb-3">
                ...
                @enderror"
                    ...
                    value="{{$data->email}} @error('emailaddress') {{ old('emailaddress') }} @enderror">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="username" name="username" aria-describedby="nameHelp" value="{{$data->username}} @error('username'){{ old('username') }}@enderror">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                @enderror"
                    ...
                    value="{{$data->mobile}}{{ old('mobilenumber') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="firstname" name="firstname" aria-describedby="firstNameHelp" value="{{$data->firstname}}{{ old('firstname') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="1" @if($data->gender == 1) checked @endif>
                    <label class="form-check-label" for="inlineRadio1">Male</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="2" @if($data->gender == 2) checked @endif>
                    <label class="form-check-label" for="inlineRadio2">Female</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gender" id="inlineRadio3" value="3" @if($data->gender == 3) checked @endif>
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="doorno" name="doorno" aria-describedby="doornoHelp" value="{{$data->doorno}}{{ old('doorno') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                @enderror"
                    ...
                    value="{{$data->streetname}}{{ old('streetname') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror "
                    id="city" name="city" aria-describedby="cityHelp" value="{{$data->city}}{{ old('city') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="state" name="state" aria-describedby="stateHelp" value="{{$data->state}}{{ old('state') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="country" name="country" aria-describedby="countryHelp" value="{{$data->country}}{{ old('country') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="pincode" name="pincode" aria-describedby="pincodeHelp" value="{{$data->pincode}}{{ old('pincode') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="degree" name="degree" aria-describedby="degreeHelp" value="{{$data->degree}}{{ old('degree') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="branch" name="branch" aria-describedby="branchHelp" value="{{$data->branch}}{{ old('branch') }}">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="text" class="form-control" id="passedout" name="passedout"
                    value="{{$data->passedout}}{{ old('passedout') }}" aria-describedby="passedoutHelp">
        ...
        <div class="col-md-4">
            <div class="mb-3 input-group-sm">
                ...
                <input type="file"
                    ...
                    is-invalid
                @enderror"
                    id="clg_id" name="clg_id" value="{{$data->college_id_card}}{{ old('clg_id') }}" value="{{$data->college_id_card}}">
